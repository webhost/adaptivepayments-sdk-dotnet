The PayPal Adaptive Payments SDK C#.NET Class Library project contains the PayPal Adaptive Payments Stubs.
...
The PayPal Adaptive Payments SDK
--------------------------------
*	The PayPal Adaptive Payments SDK enables merchants and developers to pay almost anyone and set up automated payments.
